        ...
        <div>
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input type="password" required minLength={5} className="form-control" name='password' onChange={onChange} id="password" />
                </div>
                <div className="mb-3">
                    <label htmlFor="cpassword" className="form-label">Confirm Password</label>
                    <input type="password" required minLength={5} className="form-control" name='cpassword' onChange={onChange} id="cpassword" />
                </div>
